...
# 2013-05-06
#
# Add table for competition categories
...
ALTER TABLE `tlk_competition_categories`
	ADD CONSTRAINT `competition_categories_competition_id_fk` FOREIGN KEY (`competition_id`) REFERENCES `tlk_competitions` (`id`) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE `tlk_competition_categories`
	ADD CONSTRAINT `competition_categories_category_fk` FOREIGN KEY (`category`) REFERENCES `tlk_competition_category` (`name`) ON UPDATE CASCADE ON DELETE CASCADE;
